    ...
    <body>
        ...
        <main class="main">
                    ...
                    <div class="row">
                        ...
                        <div class="my-4">
                            ...
                            <p>At G.D. Goenka Public School, Bareilly, our management team is united by a shared passion
                                ...
                                mission to cultivate independent, imaginative, and compassionate individuals who will
                                contribute positively to society. Our management team is not only a family by relation
                                but also a family in purpose and commitment to excellence in education. Each member
                                brings a wealth of experience and expertise to our institution, working collectively to
                                foster a nurturing, student-cantered environment that embodies the highest standards of
                                academic excellence, innovation, and character development.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="team-item wow fadeInUp" data-wow-delay=".25s">
                                <div class="team-img">
                                    <img src="assets/home/place1.JPG" alt="thumb">
                                </div>

                                <div class="team-content">
                                    <div class="team-bio">
                                        <h5><a href="chairman.php">Mr. Om Narayan Singh</a></h5>
                                        <span>Chairman</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="team-item wow fadeInUp" data-wow-delay=".50s">
                                <div class="team-img">
                                    <img src="assets/management/neeta.jpeg" alt="thumb">
                                </div>

                                <div class="team-content">
                                    <div class="team-bio">
                                        <h5><a href="manager.php">Mrs. Neeta Singh</a></h5>
                                        <span>Manager</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="team-item wow fadeInUp" data-wow-delay=".75s">
                                <div class="team-img">
                                    <img src="assets/management/CEO.jpg" alt="thumb">
                                </div>

                                <div class="team-content">
                                    <div class="team-bio">
                                        <h5><a href="ceo.php">Mrs. Anshu Singh Gautam</a></h5>
                                        <span>CEO</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="team-item wow fadeInUp" data-wow-delay="1s">
                                <div class="team-img" style="object-fit:fill">
                                    <img src="assets/management/CIO.jpg" alt="thumb">
                                </div>

                                <div class="team-content">
                                    <div class="team-bio">
                                        <h5><a href="cio.php">Mr. Yajuvendra Vikram Singh</a></h5>
                                        <span>CIO</span>
                                    </div>
                                </div>
            ...
            <div class="overlay hidden" id="popup1">
                <div class="popup-content">
                    <p>At G.D. Goenka Public School, we believe that true education lies in nurturing both the intellect
                        ...
                        education that empowers students with the knowledge, skills, and values they need to contribute
            ...
            <div class="overlay hidden" id="popup2">
                <div class="popup-content">
                    <p>In line with our management’s dedication to fostering excellence, we offer a dynamic curriculum
                        ...
                        environment. By catering to diverse learning styles and encouraging critical thinking, we ensure
            ...
            <div class="overlay hidden" id="popup4">
                <div class="popup-content">
                    <p>Aligned with our core values of Integrity, Excellence, Heritage, and Compassion, we are committed
                    ...
                    <div class="department-slider owl-carousel owl-theme">
                        ...
                        <div class="department-item">
                            ...
                            <div class="department-info">
                                ...
                                <p>Guided by the visionary leadership of our Chairman, a retired IAS officer, our
                                    institution is built on the belief that education is the foundation of

                                    nation-building. <span class="more-text" style="display: none;">We nurture
                                        every aspect of a student’s development—intellectual,
                                        emotional, social, and ethical—preparing them for success in life, not just in
                                        academics.</span>
                        ...
                        <div class="department-item department-item1">
                            ...
                            <div class="department-info">
                                ...
                                <p>Our core values—Integrity, Excellence, Heritage, and Compassion—are at the heart of
                                    everything we do. We instill these values in our students, ensuring that they grow
                        ...
                        <div class="department-item department-item1">
                            ...
                            <div class="department-info">
                                ...
                                <p>Our state-of-the-art facilities and technology-driven approach to education ensure
                                    that our students are prepared for the<span class="more-text"
                                        style="display: none;"> demands of the 21st century.
                                        From digital
                                        literacy to innovative learning methods, we equip students with the skills they
                                        need
                            ...
                            <div class="department-info">
                                ...
                                <p>The safety and well-being of our students are our top priorities. We provide a
                                    secure, supportive environment where students can<span class="more-text"
                                        ...
                                        and
                                        academically. Our focus on mental, emotional, and physical well-being ensures
                                        that
                        ...
                        <div class="department-item department-item3">
                            ...
                            <div class="department-info">
                                <h4 class="department-title"><a href="#">Strong Partnership with
                                        Parents</a></h4>
                                <p>We believe that education is a collaborative effort, and we work closely with parents
