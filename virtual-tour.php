    ...
    <body>
        ...
        <main class="main">
            ...
            <div class="site-breadcrumb" style="background: url(assets/home/alltop.webp)">
                <div class="container">
                    <h2 class="breadcrumb-title">Virtual Tour</h2>
            ...
            <div class="team-area pt-120">
                <div class="container justifying">
                    <div class="row">
                        <div class="col-lg-6 mx-auto">
                            <div class="site-heading text-center" id="who">
                                <span class="site-title-tagline"><i class="far fa-book-open-reader"></i> Virtual
                                    Tour</span>
                                <h2 class="site-title" id="intro">Explore Your <span>Future Campus!</span></h2>
            ...
            <div class="video-area pb-50">
                <div class="container">
                    
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                <div class="video-wrapper">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/GzH8dngv9rg?si=YxHkEqMKLCKqV7XK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
