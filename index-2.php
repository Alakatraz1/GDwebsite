...
<span>Follow Us: </span>
<a href="index-2.php#"><i class="fab fa-facebook-f"></i></a>
<a href="index-2.php#"><i class="fab fa-instagram"></i></a>
<a href="index-2.php#"><i class="fab fa-youtube"></i></a>
<a href="index-2.php#"><i class="fab fa-whatsapp"></i></a>
</div>
</div>
...
<ul>
<li>
<a href="index-2.php#"><i class="far fa-location-dot"></i> 25/B Milford Road, New York</a>
</li>
<li>
<a href="https://live.themewild.com/cdn-cgi/l/email-protection#751c1b131a35100d14180519105b161a18"><i class="far fa-envelopes"></i> <span class="__cf_email__" data-cfemail="224b4c444d62475a434f524e470c414d4f">[email&#160;protected]</span></a>
</li>
<li>
...
<a class="nav-link dropdown-toggle active" href="index-2.php#" data-bs-toggle="dropdown">Home</a>
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="index-2.php#" data-bs-toggle="dropdown">Courses</a>
<ul class="dropdown-menu fade-down">
...
<a class="nav-link dropdown-toggle" href="index-2.php#" data-bs-toggle="dropdown">Academics</a>
...
<a href="index-2.php#" class="menu-about-logo"><img src="assets/img/logo/logo.png" alt></a>
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="index-2.php#" data-bs-toggle="dropdown">Pages</a>
<ul class="dropdown-menu fade-down">
<li><a class="dropdown-item" href="about.php">About Us</a></li>
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-2.php#">Events</a>
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-2.php#">Portfolio</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-2.php#">Teachers</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-2.php#">Authentication</a>
<ul class="dropdown-menu">
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="index-2.php#" data-bs-toggle="dropdown">Admissions</a>
<ul class="dropdown-menu fade-down">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-2.php#">Our Campus</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-2.php#">Our Facilities</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-2.php#">Our Research</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-2.php#">Our Clubs</a>
<ul class="dropdown-menu">
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="index-2.php#" data-bs-toggle="dropdown">Blog</a>
<ul class="dropdown-menu fade-down">
...
<a href="contact.php" class="theme-btn theme-btn2">Learn More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<a href="course-single.php">Acting And Drama</a>
</h4>
<p class="course-text">
There are many variations of passages orem psum available but the majority have
...
<h4 class="course-title">
<a href="course-single.php">Art And Design</a>
</h4>
<p class="course-text">
There are many variations of passages orem psum available but the majority have
suffer alteration in some form by injected.
...
<h4 class="course-title">
<a href="course-single.php">Biology And Conservation</a>
</h4>
<p class="course-text">
There are many variations of passages orem psum available but the majority have
suffer alteration in some form by injected.
...
<h4 class="course-title">
<a href="course-single.php">Science And Engineering</a>
</h4>
<p class="course-text">
There are many variations of passages orem psum available but the majority have
suffer alteration in some form by injected.
...
<h4 class="course-title">
<a href="course-single.php">Health Administration</a>
</h4>
<p class="course-text">
There are many variations of passages orem psum available but the majority have
suffer alteration in some form by injected.
...
<h4 class="course-title">
<a href="course-single.php">Accounting And Finance</a>
</h4>
<p class="course-text">
There are many variations of passages orem psum available but the majority have
suffer alteration in some form by injected.
...
<a href="index-2.php#"><i class="fab fa-facebook-f"></i></a>
<a href="index-2.php#"><i class="fab fa-whatsapp"></i></a>
<a href="index-2.php#"><i class="fab fa-linkedin-in"></i></a>
<a href="index-2.php#"><i class="fab fa-youtube"></i></a>
</div>
...
<div class="event-btn">
<a href="event-single.php" class="theme-btn">Join Event<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="cta-btn">
<a href="application-form.php" class="theme-btn">Apply Now<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
</div>
...
<div class="department-info">
<h4 class="department-title"><a href="academic-single.php">Information Technology</a></h4>
<p>There are many variations of passages the majority have some injected humour.</p>
<div class="department-btn">
<a href="academic-single.php">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
...
<div class="department-info">
<h4 class="department-title"><a href="academic-single.php">Acting And Drama</a></h4>
<p>There are many variations of passages the majority have some injected humour.</p>
<div class="department-btn">
<a href="academic-single.php">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
...
<div class="department-info">
<h4 class="department-title"><a href="academic-single.php">Human Resource</a></h4>
<p>There are many variations of passages the majority have some injected humour.</p>
<div class="department-btn">
<a href="academic-single.php">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
...
<ul>
<li><a href="index-2.php#"><i class="far fa-user-circle"></i> By Alicia Davis</a></li>
<li><a href="index-2.php#"><i class="far fa-comments"></i> 03 Comments</a></li>
</ul>
</div>
<h4 class="blog-title">
<a href="blog-single.php">There are many variations passage have suffered available.</a>
</h4>
<a class="theme-btn" href="blog-single.php">Read More<i class="fas fa-arrow-right-long"></i></a>
</div>
</div>
</div>
<div class="col-md-6 col-lg-4">
...
<li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#375e59515877524f565a475b521954585a"><i class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="5b32353d341b3e233a362b373e75383436">[email&#160;protected]</span></a></li>
</ul>
</div>
</div>
...
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> About Us</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> FAQ's</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Testimonials</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Terms Of Service</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Privacy policy</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Update News</a></li>
</ul>
</div>
</div>
<div class="col-md-6 col-lg-3">
...
<ul class="footer-list">
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Campus Safety</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Student Activities</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Academic Department</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Planning & Administration</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Office Of The Chancellor</a></li>
<li><a href="index-2.php#"><i class="fas fa-caret-right"></i> Facility Services</a></li>
</ul>
</div>
</div>
<div class="col-md-6 col-lg-3">
...
&copy; Copyright <span id="date"></span> <a href="index-2.php#"> Eduka </a> All Rights Reserved.
</p>
</div>
<div class="col-md-6 align-self-center">
...
<a href="index-2.php#" id="scroll-top"><i class="far fa-arrow-up-from-arc"></i></a>
