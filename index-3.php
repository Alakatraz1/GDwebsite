...
<a href="index-3.php#">Login</a>
<a href="index-3.php#">Safety & Security</a>
<a href="index-3.php#">Students</a>
<a href="index-3.php#">Help Desk</a>
<a href="index-3.php#">Alumni</a>
<a href="index-3.php#">Faculty</a>
<a href="index-3.php#">Sitemap</a>
</div>
</div>
</div>
</div>
...
<a class="nav-link dropdown-toggle active" href="index-3.php#" data-bs-toggle="dropdown">Home</a>
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="index-3.php#" data-bs-toggle="dropdown">Courses</a>
<ul class="dropdown-menu fade-down">
...
<a class="nav-link dropdown-toggle" href="index-3.php#" data-bs-toggle="dropdown">Academics</a>
...
<a href="index-3.php#" class="menu-about-logo"><img src="assets/img/logo/logo-light.png" alt></a>
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="index-3.php#" data-bs-toggle="dropdown">Pages</a>
<ul class="dropdown-menu fade-down">
<li><a class="dropdown-item" href="about.php">About Us</a></li>
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-3.php#">Events</a>
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-3.php#">Portfolio</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-3.php#">Teachers</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-3.php#">Authentication</a>
<ul class="dropdown-menu">
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="index-3.php#" data-bs-toggle="dropdown">Admissions</a>
<ul class="dropdown-menu fade-down">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-3.php#">Our Campus</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-3.php#">Our Facilities</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-3.php#">Our Research</a>
<ul class="dropdown-menu">
...
<li class="dropdown-submenu">
<a class="dropdown-item dropdown-toggle" href="index-3.php#">Our Clubs</a>
<ul class="dropdown-menu">
...
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="index-3.php#" data-bs-toggle="dropdown">Blog</a>
<ul class="dropdown-menu fade-down">
...
<a href="contact.php" class="theme-btn mt-2">Have Any Question ?</a>
</div>
</div>
<div class="col-lg-6">
...
<ul>
<li><a href="index-3.php#"><i class="far fa-user-circle"></i> By Alicia Davis</a></li>
<li><a href="index-3.php#"><i class="far fa-comments"></i> 03 Comments</a></li>
</ul>
</div>
<h4 class="blog-title">
...
<a href="index-3.php#" class="footer-logo">
...
<li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#60090e060f200518010d100c054e030f0d"><i class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="9bf2f5fdf4dbfee3faf6ebf7feb5f8f4f6">[email&#160;protected]</span></a></li>
</ul>
</div>
</div>
...
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> About Us</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> FAQ's</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Testimonials</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Terms Of Service</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Privacy policy</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Update News</a></li>
</ul>
</div>
</div>
<div class="col-md-6 col-lg-3">
...
<ul class="footer-list">
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Campus Safety</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Student Activities</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Academic Department</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Planning & Administration</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Office Of The Chancellor</a></li>
<li><a href="index-3.php#"><i class="fas fa-caret-right"></i> Facility Services</a></li>
</ul>
</div>
</div>
<div class="col-md-6 col-lg-3">
...
&copy; Copyright <span id="date"></span> <a href="index-3.php#"> Eduka </a> All Rights Reserved.
</p>
</div>
<div class="col-md-6 align-self-center">
<ul class="footer-social">
<li><a href="index-3.php#"><i class="fab fa-facebook-f"></i></a></li>
<li><a href="index-3.php#"><i class="fab fa-whatsapp"></i></a></li>
...
<a href="index-3.php#" id="scroll-top"><i class="far fa-arrow-up-from-arc"></i></a>
